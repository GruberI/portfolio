    ...
    <div className="carousel-wrapper">
      <div className="bookly-div">
        ...
        <div class="carousel-p-div">
          <p className="carousel-p">Bookly is a web app that brings together the stories & the people you love. A web application that organinzes virtual bookclubs for users and their friends. Bookly was my final project for the Ironhack bootcamp and winner of my cohorts final competition.</p>
